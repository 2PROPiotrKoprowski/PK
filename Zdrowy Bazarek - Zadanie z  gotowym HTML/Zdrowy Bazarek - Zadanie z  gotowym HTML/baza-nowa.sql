...
(3, 'Ziemniaki Irys', 'warzywo', 1.80, 'ziemniak.png'),
(4, 'Marchewka Karotka', 'warzywo', 2.50, 'marchew.png'),
(5, 'Cebula Czerwona', 'warzywo', 3.00, 'cebula.png'),
(6, 'Pomidor Malinowy', 'warzywo', 12.00, 'pomidor.png'),
(7, 'Śliwka Węgierka', 'owoc', 4.50, 'sliwka.png'),
(8, 'Kasza Gryczana', 'sypkie', 6.00, 'kasza.png'),
(9, 'Ryż Biały', 'sypkie', 4.80, 'ryz.png'),
(10, 'Orzechy Włoskie', 'bakalie', 25.00, 'orzech.png');
